...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PocketTest " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"PocketTesttools.com", "dnsseed.PocketTesttools.com"},

    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"PocketTesttools.com", "testnet-seed.PocketTesttools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PocketTest is probably already running."), addrBind.ToString().c_str());
        else
